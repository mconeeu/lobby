...
public class CompassInventory extends CoreInventory {
    ...
    public CompassInventory(Player p) {
        ...
        }.runTaskLater(Lobby.getInstance(), 8L);
        ...
        }.runTaskLater(Lobby.getInstance(), 10L);
        ...
        }.runTaskLater(Lobby.getInstance(), 12L);
        ...
        }.runTaskLater(Lobby.getInstance(), 15L);
        ...
        }.runTaskLater(Lobby.getInstance(), 17L);
