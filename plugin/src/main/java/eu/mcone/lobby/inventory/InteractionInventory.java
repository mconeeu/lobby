...
public class InteractionInventory extends CoreInventory {
    ...
    public InteractionInventory(Player p, Player clicked) {
        ...
        setItem(InventorySlot.ROW_3_SLOT_3, new Skull("http://textures.minecraft.net/texture/6f74f58f541342393b3b16787dd051dfacec8cb5cd3229c61e5f73d63947ad", 1).setDisplayName("§7Online-Profil Ansehen").getItemStack(), e -> {
