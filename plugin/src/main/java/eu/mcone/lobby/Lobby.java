...
import eu.mcone.lobby.inventory.modify.ProfileInventoryModifier;
import eu.mcone.lobby.inventory.modify.ProfilePlayerInventoryModifier;
...
public class Lobby extends LobbyPlugin {
    ...
    public void onGameEnable() {
        ...
        CoreSystem.getInstance().getPluginManager().registerCoreInventoryModifier(ProfileInventory.class, new ProfileInventoryModifier());
        CoreSystem.getInstance().getPluginManager().registerCoreInventoryModifier(ProfilePlayerInventory.class, new ProfilePlayerInventoryModifier());
