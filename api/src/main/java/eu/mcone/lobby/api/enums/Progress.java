...
public enum Progress {
    ...
    MANDALAI(6, "Hexe", new String[]{"§e Du hast ein Zauber Trank gekauft"}, "mandalai", LobbyWorld.ONE_ISLAND, "§8[§7§l!§8] §cNPC §8» §fMandalai §8|§7 Hallo mein Freund du musst %%player%% sein. Uhh was hast du denn da in dein Rucksack ein §5Zauberstab §7der sieht echt cool aus aber du willst doch irgend etwas kaufen. nehm dir am besten dein Trank aus meinen Kelch du kannst mir am besten 20 Coins da lassen. Das passt schon. Geh am besten dann wieder nach Edward der hat mir gesagt der warte auf dich im Rathaus."),
    EDWARD_CITYHALL(7, "Lage Besprechung", new String[]{"§eEdward hat dir genauere Kordinaten von Rufi erzählt"}, "edward-cityhall", LobbyWorld.ONE_ISLAND, "§8[§7§l!§8] §cNPC §8» §fEdward §8|§7 Hallo %%player%% ahh da bist wieder und du hast den Trank dabei du musst jetzt schnell Rufi finden ich weiß selbst nicht wo er ist er wird aber bestimnnt irgend wo in einer Höhle festgehalten "),
    INFECTION(8, "Infizierung", new String[]{"§eDu hast Herr Rufi geheilt!"}, "rufi-infected", LobbyWorld.ONE_ISLAND, "§8[§7§l!§8] §cNPC §8» §fHeer Rufi §8|§7 Danke Danke du hast mich gerretet du kannst dir die belohnung in der Mitte von der Insel abholen da ist ein sehr großes Loch spring da einfach runter und da kannst du dir dann deine Belohnung abholen"),
