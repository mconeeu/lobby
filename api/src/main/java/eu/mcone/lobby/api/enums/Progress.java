...
public enum Progress {
    ...
    INFECTION(8, "Infizierung", new String[] {"§eDu hast Rufi zurück infiziert"}, "rufi-infected", LobbyWorld.ONE_ISLAND, "§8[§7§l!§8] §cNPC §8» §fHeer Rufi §8|§7 Danke Danke du hast mich gerretet du kannst dir die belohnung in der Mitte von der Insel holen da ist eine Fackel und da neben ein Knopf den musst du betätigen dann hast du deine Belohnung"),
