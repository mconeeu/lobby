...
@Getter
public enum TutorialStoryProgress {
    ...
    TutorialStoryProgress(int id, String name, String[] description, String npcName, LobbyWorld world, String message) {
        this.id = id;
        this.name = name;
    ...
    public static TutorialStoryProgress getTutorialStoryById(int id) {
        for (TutorialStoryProgress tutorialStoryProgress : values()) {
            if (tutorialStoryProgress.getId() == id) {
                return tutorialStoryProgress;
            }
        }
