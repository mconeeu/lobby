...
public enum LobbyItem {
    ...
    ONE_HIT_SWORD(2, "One Hit Schwerdt", LobbyCategory.STORY_ITEMS, Level.MYSTICAL, 0, 0, new ItemBuilder(Material.DIAMOND_SWORD, 1, 0).displayName("§c§lOne Hit Sword").lore("§7Kategorie: §bItem", "§7Seltenheit: §cMythisch", "", "§7Schieße Blitze duch die Lobby").enchantment(Enchantment.DAMAGE_ALL, 5).unbreakable(true).itemFlags(ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_UNBREAKABLE).create()),
