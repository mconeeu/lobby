...
public enum TutorialStory {
    ...
    WELCOME(1, "Begrüßung", new String[]{"§eFrank begrüßt sich"}, "frank1", LobbyWorld.ONE_ISLAND,
            "§8[§7§l!§8] §cNPC §8» §fFrank §8|§7 Hey Ich bin Frank. Ich zeige hier jeden den Weg, ich wohne hier auf der Insel schon seit über 20 Jahren. Such doch mal den Ankäufer. Ich werde dort auf dich warten."),

    VENDOR(2, "AnKäufer", new String[]{"§eFrank zeigt dir den Verkäufer"}, "frank2", LobbyWorld.ONE_ISLAND,
            "§8[§7§l!§8] §cNPC §8» §fFrank §8|§7 Ahoi da bist du wieder hier ist unser kleiner Insel Markplatz du kannst beim Ankäufer alle deine Items in deinem Rucksack verkaufen. Probiers doch mal aus! Als nächstes such doch mal den Schmuggler."),
