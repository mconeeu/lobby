...
//        super("§8» §d§lBänker §8| §fKonto-Übersicht", p, InventorySlot.ROW_3, InventoryOption.FILL_EMPTY_SLOTS);
        ...
        setItem(InventorySlot.ROW_1_SLOT_4, new ItemBuilder(Material.SIGN, 1, 0).displayName("§f§lUmwandler").create(),
                e -> new BankChangeCoins(p));

//        setItem(InventorySlot.ROW_1_SLOT_6, new ItemBuilder(Material.SIGN, 1, 0).displayName("§f§lEmerald(s) Überweisen").create(),
//                e -> {
//
//                });
