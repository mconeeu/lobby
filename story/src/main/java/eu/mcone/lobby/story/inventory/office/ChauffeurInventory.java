...
public class ChauffeurInventory extends CoreInventory {
    ...
    public enum ChauffeurSpawnPoints {
        SPAWN(LobbyWorld.ONE_ISLAND, "spawn"),
        TOWN_HALL(LobbyWorld.ONE_ISLAND, "townHall"),
        OFFICE_ENTRANCE(LobbyWorld.ONE_ISLAND, "officeEntrance"),
        PORT(LobbyWorld.ONE_ISLAND, "port"),
        VENDOR(LobbyWorld.ONE_ISLAND, "vendor"),
        BANK(LobbyWorld.ONE_ISLAND, "bank"),
        DEALER(LobbyWorld.ONE_ISLAND, "dealer"),
        GANG(LobbyWorld.ONE_ISLAND, "gang");

        private final LobbyWorld world;
        @Getter
        private final String spawnLocation;

        ChauffeurSpawnPoints(LobbyWorld world, String spawnLocation) {
            this.world = world;
