...
public class onTrails implements Listener{
    ...
    public void onClick(InventoryClickEvent e){
        ...
        try{
            ...
            if (e.getInventory().getName().equals("§8» §6Trails")){
                ...
                if (e.getCurrentItem().getItemMeta().getDisplayName() == "§6GlowTrail"){
        ...
        try{
            ...
            if (e.getInventory().getName().equals("§8» §6Trails")){
                ...
                if (e.getCurrentItem().getItemMeta().getDisplayName() == "§5EnderTrail"){
        ...
        try{
            ...
            if (e.getInventory().getName().equals("§8» §6Trails")){
                ...
                if (e.getCurrentItem().getItemMeta().getDisplayName() == "§aMusikTrail"){
        ...
        try{
            ...
            if (e.getInventory().getName().equals("§8» §6Trails")){
                ...
                if (e.getCurrentItem().getItemMeta().getDisplayName() == "§cTrail ablegen"){
                    Var.cookies.remove(p);
                    Var.ender.remove(p);
                    Var.glow.remove(p);
                    Var.musik.remove(p);
        ...
        try{
            ...
            if (e.getInventory().getName().equals("§8» §6Trails")){
                ...
                if (e.getCurrentItem().getItemMeta().getDisplayName() == "§cLavaTrail"){
        ...
        try{
            ...
            if (e.getInventory().getName().equals("§8» §6Trails")){
                ...
                if (e.getCurrentItem().getItemMeta().getDisplayName() == "§aHeartTrail"){
        ...
        try{
            ...
            if (e.getInventory().getName().equals("§8» §6Trails")){
                ...
                if (e.getCurrentItem().getItemMeta().getDisplayName() == "§9WaterTrail"){
        ...
        try{
            ...
            if (e.getInventory().getName().equals("§8» §6Trails")){
                ...
                if (e.getCurrentItem().getItemMeta().getDisplayName() == "§fSnowTrail"){
                    if(p.hasPermission("lobby.lavatrail") || p.hasPermission("lobby.Premiumplus") || p.hasPermission("lobby.*")) {
